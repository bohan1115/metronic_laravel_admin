...
class Form
{
    ...
    protected function makeField($name, $type = 'text', array $options = [])
    {
        ...
        $options['value'] = $this->getData($name);
    ...
    public function renderBody(array $options = [],$showStart = true, $showFields = true, $showEnd = true)
    {
        $temp = [];
        foreach($this->fields as $value)
        {
            if($value->getType() == 'submit' || $value->getType() == 'reset')
            {
        ...
        return $this->render($options, $temp, $showStart, $showFields, $showEnd);
    }
